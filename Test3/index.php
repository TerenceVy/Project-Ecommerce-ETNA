...
<div id='global'>
    ...
    <div class="etna" style="margin-left: 35%; margin-top:2%;"> ETNA MANGA </div>
    ...
    <form action="partials/pop.php">
      <div class="pop">
        <input type="submit" value="  Figurine Pop   " style="position: fixed; top: 25px; left: 150px;">
      </div>
    </form>
    ...
    <form action="partials/blu-ray.php">
      <div class="achat3">
        <input type="submit" value="  Blu-ray   " style="position: fixed; top: 25px; left: 380px;">
      </div>
    </form>
    </header>
  <div id='menu-gauche'>
